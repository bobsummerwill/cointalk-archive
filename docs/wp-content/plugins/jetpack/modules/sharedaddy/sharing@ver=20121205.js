	...
	function WPCOMSharing_do() {
		...
		$( '.sharedaddy ul' ).each( function( item ) {
			...
			printUrl = function ( uniqueId, urlToPrint ) {
				$( 'body:first' ).append( '<iframe id="printFrame-' + uniqueId + '" name="printFrame-' + uniqueId + '" onload="frames[\'printFrame-' + uniqueId + '\'].focus();frames[\'printFrame-' + uniqueId + '\'].print();" src="' + urlToPrint + '/" style="position:fixed;top:100;left:100;height:1px;width:1px;border:none;"></iframe>' )
			};
...
c=(Recaptcha.checkFlashVer()?'<br/><a class="recaptcha_audio_cant_hear_link" href="sharing@ver=20121205.js" onclick="Recaptcha.playAgain(); return false;">'+RecaptchaStr.play_again+"</a>":"")+'<br/><a class="recaptcha_audio_cant_hear_link" href="'+c+'/" target="_blank">'+RecaptchaStr.cant_hear_this+"</a>";return a+c},gethttpwavurl:function(){var a=RecaptchaState;if(Recaptcha.type=="audio"){a=a.server+"image?c="+a.challenge;if(a.indexOf("https://")==0)a="http://"+a.substring(8);return a}return""},checkFlashVer:function(){var a=
